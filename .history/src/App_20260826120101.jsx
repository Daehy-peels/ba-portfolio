...
export default function App() {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen overflow-x-hidden font-['DM_Sans'] transition-colors duration-700 ${
          darkMode
      ...
      >
        ...
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          <div
            className={`absolute -left-32 top-20 h-80 w-80 rounded-full blur-3xl soft-pulse ${
              darkMode ? "bg-emerald-900/30" : "bg-emerald-200/35"
            }`}
          />

          <div
            className={`absolute -right-32 top-[35%] h-96 w-96 rounded-full blur-3xl float-reverse ${
              darkMode ? "bg-teal-900/20" : "bg-teal-100/60"
            }`}
          />

          <div
            className={`absolute left-[40%] bottom-0 h-72 w-72 rounded-full blur-3xl ${
        ...
        <header className="fixed left-0 right-0 top-4 z-50 px-3 sm:px-5">
          <nav
            className={`mx-auto flex w-full max-w-5xl items-center justify-between rounded-full border px-3 py-2.5 backdrop-blur-2xl transition-all duration-500 sm:px-5 ${
              darkMode
                ? "border-emerald-900/40 bg-slate-950/75 shadow-2xl shadow-black/30"
                : "border-emerald-100/80 bg-white/75 shadow-xl shadow-emerald-950/5"
            }`}
          >
            {/* Logo */}
            <a
            ...
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 via-green-500 to-teal-400 text-white shadow-lg shadow-emerald-500/20 transition-all duration-300 group-hover:rotate-12 group-hover:scale-110">
                <Sparkles size={15} />
              </div>

              <div className="hidden xs:block">
                <span className="font-['Outfit'] text-base font-bold tracking-tight sm:text-lg">
                  Her
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`group flex h-9 w-9 items-center justify-center rounded-full border transition-all duration-300 hover:scale-110 ${
                  darkMode
              ...
              <a
                href="#contact"
                className="hidden rounded-full bg-gradient-to-r from-emerald-600 to-green-500 px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white shadow-lg shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-emerald-500/30 sm:inline-flex"
              >
                Let's Talk
              </a>
        ...
        {/* MOBILE MENU */}
        <div
          className={`fixed inset-x-3 top-[78px] z-40 rounded-[2rem] border p-4 shadow-2xl backdrop-blur-2xl transition-all duration-300 md:hidden ${
            mobileMenuOpen
        ...
        >
          <div className="space-y-1">
            ...
            <a
              href="#contact"
              onClick={() => setMobileMenuOpen(false)}
              className="mt-2 flex items-center justify-center rounded-2xl bg-emerald-600 px-4 py-3.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/20"
            >
              Let's Talk
            </a>
          </div>
        ...
        <section
          id="about"
          className="relative mx-auto max-w-7xl px-4 pb-20 pt-32 sm:px-6 sm:pt-36 lg:px-8 lg:pb-28"
        >
          <div className="grid items-center gap-8 lg:grid-cols-12">
            ...
            >
              ...
              <div className="float-reverse pointer-events-none absolute bottom-8 right-8 hidden text-emerald-300/25 sm:block">
                <Sparkles size={72} />
              </div>

              {/* badge */}
              <div
                className={`mb-6 inline-flex items-center gap-2 rounded-full border px-3.5 py-2 text-[11px] font-bold uppercase tracking-widest ${
                  darkMode
              ...
              <h1 className="relative z-10 mb-6 font-['Outfit'] text-4xl font-extrabold leading-[1.08] tracking-tight sm:text-5xl lg:text-6xl">
                Turning{" "}
              ...
              >
                I connect business needs with practical solutions through
                data analysis, process improvement, requirements gathering,
                and thoughtful stakeholder collaboration.
              </p>
            ...
            >
              ...
              >
                ...
                <h3 className="mb-2 font-['Outfit'] text-xl font-bold">
              ...
              >
                <div className="mb-4 flex items-start justify-between">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-teal-500/10 text-teal-500 transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3">
                    <Workflow size={22} />
                  </div>

                  <span className="rounded-full bg-teal-500/10 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-teal-600 dark:text-teal-400">
                    Process
                  </span>
                </div>
              ...
              >
                ...
                <p
                  className={`relative z-10 text-sm font-medium leading-relaxed ${
                    darkMode ? "text-emerald-100" : "text-emerald-900"
                  }`}
                >
                  "Good analysis doesn't just explain what happened — it
        ...
        <section
          id="skills"
          className={`border-y py-24 transition-colors duration-500 ${
            darkMode
        ...
        >
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mb-4 font-['Outfit'] text-3xl font-extrabold tracking-tight sm:text-4xl">
                Core Competencies
              </h2>
              ...
              {[
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="mb-3 font-['Outfit'] text-xl font-bold">
                      {skill.title}
                    </h3>
        ...
        >
          ...
          >
            <div>
              ...
              <h2 className="font-['Outfit'] text-3xl font-extrabold tracking-tight sm:text-4xl">
            ...
            {/* Filters */}
            <div
              className={`flex w-full gap-2 overflow-x-auto rounded-2xl p-1.5 md:w-auto ${
                darkMode ? "bg-slate-900" : "bg-emerald-50"
              }`}
            >
              {["all", "Data Analysis", "Process Engineering"].map(
                (tab) => {
                  const value =
                    tab === "all" ? "all" : tab;
                  ...
                  return (
                    <button
                      ...
                      className={`whitespace-nowrap rounded-xl px-4 py-2.5 text-xs font-bold uppercase tracking-wider transition-all duration-300 ${
                        isActive
              ...
              >
                ...
                <div className="relative overflow-hidden p-7 pb-0">
                  ...
                  <div className="relative z-10 flex items-center justify-between">
                    <span className="rounded-full bg-emerald-500/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">
                      {project.category}
                    </span>

                    {project.featured && (
                      <span className="flex items-center gap-1 rounded-full bg-amber-100 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-amber-700 dark:bg-amber-400/10 dark:text-amber-300">
                        <Sparkles size={11} />
                        Featured
                      </span>
                    )}
                  ...
                  <h3 className="mt-5 font-['Outfit'] text-xl font-bold leading-tight transition-colors duration-300 group-hover:text-emerald-500 sm:text-2xl">
                    {project.title}
                  </h3>
                ...
                <div className="px-7 pt-6">
                  ...
                  >
                    <div className="mb-1 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">
        ...
        <section
          ...
          className={`relative overflow-hidden border-t py-24 ${
            darkMode
              ? "border-slate-800 bg-[#040a06]"
              : "border-emerald-100 bg-slate-950 text-white"
          }`}
        >
          {/* decorative blobs */}
          ...
          >
            ...
            <h2 className="font-['Outfit'] text-3xl font-extrabold tracking-tight sm:text-5xl">
            ...
            <p className="mx-auto mt-5 max-w-xl text-sm leading-relaxed text-slate-400 sm:text-base">
              ...
              organize the details, and turn them into practical solutions?
          ...
          >
            ...
            >
              ...
              <div className="pr-10">
                ...
                <h3
                  id="case-study-title"
                  className="mt-4 font-['Outfit'] text-2xl font-extrabold sm:text-3xl"
                >
                ...
                <div className="mt-7">
                  <h4 className="font-['Outfit'] text-lg font-bold">
                    Key Contributions
                  </h4>
